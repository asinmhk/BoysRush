...
public class Position3D implements Position {
    ...
    public Position3D() { x = Integer.MIN_VALUE; y = Integer.MIN_VALUE; z = Integer.MIN_VALUE; }

    public Position3D(int locx, int locy, int locz) { x = locx; y = locy; z = locz; }

    public Position3D(int locx, int locy) { x = locx; y = locy; z = 0; }
